...
from com.tencent.test.TestCase_1906A import TestCase_1906A
...
def send_email(newfile):
    ...
    user = '15330276178@163.com'
    # 授权密码
    password = 'zhiyuan09321'
    # 发送邮箱
    sender = '15330276178@163.com'
    # 多个接收邮箱，单个收件人的话，直接是receiver='XXX@126.com'
    receiver = ['15330276178@163.com', "843404536@qq.com"]
    # 发送邮件主题
    subject = '1906A_自动定时发送测试报告' + str(time.strftime('%Y%m%d%H%M%S'))
    # 编写 HTML类型的邮件正文
    ...
    msg['From'] = '15330276178@163.com <15330276178@163.com>'
...
if __name__ == '__main__':
    ...
    # CSDN--别倒错------------------------------------------------------
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(TestCase_1906A))
    # 定义测试报告的路径，标题，描述等内容
